...
const WorksImgLeft: React.FC<WorksImgLeftProps> = ({
	...
	return (
		<motion.div
			className="flex flex-col-reverse md:flex-row justify-between items-center px-5 md:px-[10vw] my-20 mb-20 md:my-32 md:mb-40 h-full md:h-[260px] w-full font-bitter"
			initial={{opacity: 0, x: -100}}
			whileInView={{opacity: 1, x: 0}}
			viewport={{margin: "-20%", once: true}}
			transition={{duration: 0.5, type: "spring", bounce: 0.5}}
		>
			<div className="flex flex-col justify-center gap-2 md:gap-5 items-start h-full w-full mt-3 md:mt-0 md:mr-40">
